/**\file TOIFactoredRewardDecPOMDPDiscrete.h
 *
 * Authors:
 ...
 *
 * $Id: TOIFactoredRewardDecPOMDPDiscrete.h 4016 2010-03-11 16:56:02Z mtjspaan $
 */
...
public:
    ...
    TOIFactoredRewardDecPOMDPDiscrete(
        std::string name="received unspec. by TOIFactoredRewardDecPOMDPDiscrete", 
        std::string descr="received unspec. by TOIFactoredRewardDecPOMDPDiscrete", 
        std::string pf="received unspec. by TOIFactoredRewardDecPOMDPDiscrete");
